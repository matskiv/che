...
public class DockerImageEnvironmentConverterTest {
  ...
  public void shouldBeAbleToConvertToDockerEnvironment() throws Exception {
    // given
    InternalRecipe recipe = mock(InternalRecipe.class);
    ...
    DockerEnvironment expectedEnv =
        new DockerEnvironment(recipe, null, null)
            .setContainers(singletonMap(DEFAULT_MACHINE_NAME, expectedContainer));
